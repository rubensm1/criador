...
abstract class Model implements JsonSerializable {
    ...
    public static function htmlTable($limit = 0) {
        ...
        foreach ($consulta as $result) {
            ...
            $botao = '<td><form action="index.php?c=submain&p='.$class.'" method="POST" target="paineis"><input type="hidden" name="id" value="'.$result["id"].'" /><input type="submit" value="Selecionar"/></form></td>';
            $html .= $botao."</tr>";
        }
